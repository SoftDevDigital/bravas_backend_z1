...
function loadCredentials(environment = 'dev') {
    ...
    if (normalizedEnv === 'dev') {
        console.log(...oo_oo(`3521556482_103_4_111_6_4`, '🔍 [loadCredentials] Variables de DynamoDB:', {
            desdeEntorno: {
...
function loadFromEnvironment() {
    ...
    if (!hasRegion || !hasAccessKey || !hasSecretKey) {
        if (process.env.DEBUG_CONFIG === 'true') {
            console.log(...oo_oo(`3521556482_153_6_158_8_4`, 'Debug - Variables de entorno:', {
